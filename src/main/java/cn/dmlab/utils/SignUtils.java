...
public class SignUtils {
     ...
     * @return sign tx
     */
    public static BxhTransactionOuterClass.BxhTransaction sign(BxhTransactionOuterClass.BxhTransaction unsignedTx
            , ECKeyS256 ecKeyS256) {
    ...
    public static byte[] needToHash(BxhTransactionOuterClass.BxhTransaction unsignedTx) {
    ...
    public static BxhTransactionOuterClass.BxhTransaction sign(BxhTransactionOuterClass.BxhTransaction unsignedTx, ECKeyPair ecKey) {
        byte[] signMessage = HashUtil.sha3(needToHash(unsignedTx));
