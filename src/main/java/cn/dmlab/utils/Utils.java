...
public class Utils {
    ...
    public static Long genTimestamp() {
        return (new Date()).getTime() * 1000000L + (long) randInt(1000, 1000000);
    }
     ...
     * Get IBTP ID
     *
     * @param ibtp IBTP protobuf
     * @return
     */
    public static String ibtpID(Ibtp.IBTP ibtp) {
        return String.format("%s-%s-%d", ibtp.getFrom(), ibtp.getTo(), ibtp.getIndex());
    }
}
